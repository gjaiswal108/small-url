...
<div class="container pt-4 block">
	...
	<div class="jumbotron bg-light shadow p-5 rounded">
		<form id='login_form'>
			...
			<div class="form-group">
			    <input type="text" class="form-control" placeholder="Enter custom page name" id="custom_page" name="custom_page">
			</div>
			<div class="form-group">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Enter the captcha" id="captcha" name="captcha">
				    <span class="input-group-append"><img src="api/captcha_image.php" id="captcha_image" /></span>
				</div>
			</div>
			<div align="center" class="form-group">
				<button type="button" class="btn btn-primary mr-2">Short it</button>
		...
		<div class="list-group" align="center" id="QR">
